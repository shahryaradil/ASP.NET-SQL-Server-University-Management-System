<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CourseRegistration.aspx.cs" Inherits="DB_Project.Pages.CourseRegistration" %>
...
<body>
    ...
    <form runat="server">
        ...
        <asp:DropDownList ID="courseDropDown" runat="server" class="input"></asp:DropDownList>
