<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Evaluate.aspx.cs" Inherits="DB_Project.Pages.Evaluate" %>
...
<body>
    ...
    <div class="profile">
        <div class="section">
            <form runat="server">
                <asp:Label class="cName" ID="courseCodeLabel" runat="server"></asp:Label>
                <asp:Label class="cName" ID="courseNameLabel" runat="server"></asp:Label>
                <asp:Label class="cName" ID="sectionLabel" runat="server"></asp:Label>
                <label>Evaluation Name: </label>
                <br />
                <input type="text" runat="server" id="inputEvalName" />
                <br />
                <label>Total Marks: </label>
                <br />
                <input type="text" runat="server" id="inputTotalMarks" />
                ...
                <asp:Label class="cName" ID="successLabel" runat="server"></asp:Label>
            </form>
        </div>
    </div>
